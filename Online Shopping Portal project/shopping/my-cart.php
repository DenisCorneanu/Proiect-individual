...
if(isset($_POST['submit'])){
		...
		foreach($_POST['quantity'] as $key => $val){
			...
			echo "<script>alert('Cosul a fost actualizat');</script>";
		}
	}
...
// code for billing address updation
	if(isset($_POST['update']))
	{
		...
		if($query)
		{
echo "<script>alert('Adresa facturare actualizata');</script>";
		}
	}
...
// code for Shipping address updation
	if(isset($_POST['shipupdate']))
	{
		...
		if($query)
		{
echo "<script>alert('Adresa de livrare actualizata');</script>";
		}
	}
...
if(!empty($_SESSION['cart'])){
	?>
		<table class="table table-bordered">
			<thead>
				<tr>
					<th class="cart-romove item">Inlatura</th>
					<th class="cart-description item">Imagine</th>
					<th class="cart-product-name item">Nume produsa</th>
			
					<th class="cart-qty item">Cantitate</th>
					<th class="cart-sub-total item">Pret per unitate</th>
					<th class="cart-sub-total item">Taxa livrare</th>
				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="index.php" class="btn btn-upper btn-primary outer-left-xs">Continua cumparaturile</a>
								<input type="submit" name="submit" value="Actualizeaza cosul" class="btn btn-upper btn-primary pull-right outer-right-xs">
							</span>
...
?>
								<div class="reviews">
									( <?php echo htmlentities($num);?> Recenzii )
								</div>
								<?php } ?>
							</div>
						</div><!-- /.row -->
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "RON"." ".$row['productPrice']; ?>.00</span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "RON"." ".$row['shippingCharge']; ?>.00</span></td>
...
$_SESSION['pid']=$pdtid;
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Adresa livrare</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="form-group">
					    <label class="info-title" for="Billing Address">Adresa<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Tara  <span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="bilingstate" value="<?php echo $row['billingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">Oras<span>*</span></label>
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">Cod Postal <span>*</span></label>
					  ...
					  <button type="submit" name="update" class="btn-upper btn btn-primary checkout-page-button">Actualizeaza</button>
...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Date facturare</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="form-group">
					    <label class="info-title" for="Shipping Address">Adresa<span>*</span></label>
 ...
 <div class="form-group">
					  ...
					  <button type="submit" name="shipupdate" class="btn-upper btn btn-primary checkout-page-button">Actualizeaza</button>
					<?php } ?>
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">Finalizeaza comanda</button>
