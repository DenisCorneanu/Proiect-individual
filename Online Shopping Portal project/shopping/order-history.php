		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-product-name item">Nume produs</th>
					...
					<th class="cart-total item">Metoda de plata</th>
					<th class="cart-description item">Data livrarii</th>
					<th class="cart-total last-item">Actioneaza</th>
				</tr>
			</thead><!-- /thead -->
