...
<div class="search-area">
    <form name="search" method="post" action="search-result.php">
        <div class="control-group">
            ...
            <input class="search-field" placeholder="Cauta aici" name="product" required="required" />
		...
		<a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
			<div class="items-cart-inner">
				<div class="total-price-basket">
					<span class="lbl">cos cumparaturi -</span>
	...
	?>
			...
			<div class="clearfix cart-total">
				<div class="pull-right">
						...
						<span class="text">Total :</span><span class='price'><?php echo $_SESSION['tp']="$totalprice". ".00"; ?>RON</span>
...
<div class="dropdown dropdown-cart">
		...
		<ul class="dropdown-menu">
			...
			<div class="clearfix cart-total">
				...
				<a href="index.php" class="btn btn-upper btn-primary btn-block m-t-20">Continua cumparaturile</a>	
			</div><!-- /.cart-total-->
