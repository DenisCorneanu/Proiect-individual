					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									RON <?php echo htmlentities($rws['productPrice']);?>.00
								</span>
									
							    <span class="price-before-discount">RON<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>					
						...
						<div class="cart clearfix animate-effect">
							...
							<button class="btn btn-primary" type="button">Adauga in cos</button></a>
								<?php } else {?>
							<div class="action" style="color:red">Iesit din stoc</div>
					<?php } ?>
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Brand produs :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Taxa livrare :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price"><?php echo htmlentities($row['productPrice']);?> RON</span>
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
<?php if($row['productAvailability']=='In Stock'){?>
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> Adauaga in cos</a>
													<?php } else {?>
							<div class="action" style="color:red">Iesit din stoc</div>
					<?php } ?>
									</div>
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								<li class="active"><a data-toggle="tab" href="#description">Descriere</a></li>
								<li><a data-toggle="tab" href="#review">Recenzii</a></li>
								...
								<div id="review" class="tab-pane">
									<div class="product-tab">
										...
										<div class="product-reviews">
											<h4 class="title">Recenzii clienti</h4>
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Calitate :</b>  <?php echo htmlentities($rvw['quality']);?> Star</div>
													<div class="text"><b>Pret :</b>  <?php echo htmlentities($rvw['price']);?> Star</div>
													<div class="text"><b>Valoare :</b>  <?php echo htmlentities($rvw['value']);?> Star</div>
										...
										<div class="product-add-review">
											<h4 class="title">Scrie recenzia ta</h4>
											<div class="review-table">
												<div class="table-responsive">
													<table class="table table-bordered">	
														...
														<tbody>
															<tr>
																<td class="cell-label">Calitate</td>
															...
															<tr>
																<td class="cell-label">Valoare</td>
														...
														<div class="row">
															<div class="col-sm-6">
																<div class="form-group">
																	<label for="exampleInputName">Nume <span class="astk">*</span></label>
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label for="exampleInputReview">Recenzie <span class="astk">*</span></label>
...
<textarea class="form-control txt txt-review" id="exampleInputReview" rows="4" placeholder="" name="review" required="required"></textarea>
														...
														<div class="action text-right">
															<button name="submit" class="btn btn-primary btn-upper">Trimite</button>
														</div><!-- /.action -->
...
<section class="section featured-product wow fadeInUp">
	<h3 class="section-title">Produse recomandate </h3>
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					<?php echo htmlentities($rw['productPrice']);?>RON			</span>
										     <span class="price-before-discount">RON
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">Adauga in cos</a>
